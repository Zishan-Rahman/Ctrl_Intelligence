...
def app_accept(request, pk):
    ...
    app.delete()
    messages.add_message(request, messages.SUCCESS, f"{app.applicant.first_name} {app.applicant.last_name} has been accepted to {app.club.name} !")
...
def app_remove(request, pk):
    ...
    app = Application.objects.all().get(pk=pk)
    app.delete()
    messages.add_message(request, messages.SUCCESS, f"{app.applicant.first_name} {app.applicant.last_name} has been rejected from {app.club.name} !")
    return redirect('applications')
