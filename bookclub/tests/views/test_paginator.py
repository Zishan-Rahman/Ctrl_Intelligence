...
class PaginationTests(TestCase):
    ...
    def check_paginator(self, params, output):
        ...
        self.check_attribute('page_range', paginator,
                             page_range, params, coerce=list)
    ...
    def check_indexes(self, params, page_num, indexes):
        ...
        self.assertEqual(start, page.start_index(), msg % (
            'start index', page_num, start, page.start_index(), params))
        self.assertEqual(end, page.end_index(), msg %
                         ('end index', page_num, end, page.end_index(), params))
    ...
    def test_page_range_iterator(self):
        ...
        self.assertIsInstance(
            Paginator([1, 2, 3], 2).page_range, type(range(0)))
    ...
    def test_get_elided_page_range(self):
        ...
        for pages, on_each_side, on_ends, elided_after in tests:
            for offset in range(elided_after + 1):
                with self.subTest(pages=pages, offset=elided_after, on_each_side=on_each_side, on_ends=on_ends):
                    ...
                    self.assertIsInstance(
                        page_range, collections.abc.Generator)
        ...
        tests = [
            ...
            (44, 4, 0, [ELLIPSIS, 40, 41, 42,
             43, 44, 45, 46, 47, 48, ELLIPSIS]),
