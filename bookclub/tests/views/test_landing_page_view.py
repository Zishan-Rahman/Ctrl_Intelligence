"""Unit tests for the Landing Page Redirect View"""
...
class LandingPageRedirectTestCase(TestCase):
    """Test case to see if the landing page redirects to the login page when logged in"""
    ...
    def test_landing_page_shows_when_user_not_logged_in(self):
        """Testing landing page when user is not logged in."""
    ...
    def test_landing_page_redirects_to_home_when_user_logged_in(self):
        """Testing landing page when user is logged in."""
