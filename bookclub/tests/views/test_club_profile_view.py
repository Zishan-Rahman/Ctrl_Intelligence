...
class ClubProfileTest(TestCase , LogInTester):
    ...
    def test_club_profile_has_correct_details(self):
        ...
        self.assertIn(f'<h6 class="card-title" ><a href="/user_profile/{self.bush_club.owner.id}">{self.bush_club.owner.first_name} {self.bush_club.owner.last_name}</a></h6>', html)
