    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('small_url', models.URLField(max_length=512, unique=True)),
                ('medium_url', models.URLField(max_length=512, unique=True)),
                ('large_url', models.URLField(max_length=512, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Club',
