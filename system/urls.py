...
urlpatterns = [
    ...
    #path('my_past_book_ratings/', book_views.past_book_ratings, name="past_book_ratings"),
    path('my_past_book_ratings/', book_views.MyBookRatings.as_view(), name="past_book_ratings"),
