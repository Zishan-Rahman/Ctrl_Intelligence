...
from bookclub.views import account_views, authentication_views, dashboard_views, book_views, club_views, user_views, \
    search_views, application_views, meeting_views, messaging_views, club_feed_views, post_views, user_feed_views, \
    user_post_views
...
urlpatterns = [
     ...
     path('reading_list/<int:book_id>/remove_book/', book_views.remove_from_reading_list_page,
          name='remove_from_reading_list'),
     path('books/add_to_reading_list/<int:book_id>/', book_views.add_to_reading_list_book_list,
          name='add_to_reading_list_book_list'),
     path('books/remove_from_reading_list/<int:book_id>/', book_views.remove_from_reading_list_book_list,
          name='remove_from_reading_list_book_list'),
     path('book_profile/<int:book_id>/add_to_reading_list/', book_views.add_to_reading_list_book_profile,
          name='add_to_reading_list_book_profile'),
     path('book_profile/<int:book_id>/remove_from_reading_list/', book_views.remove_from_reading_list_book_profile,
          name='remove_from_reading_list_book_profile'),
     ...
     path('club_profile/<int:c_pk>/members/<int:u_pk>/promote', club_views.promote_member_to_organiser,
          name='promote_member_to_organiser'),
     path('club_profile/<int:c_pk>/members/<int:u_pk>/demote', club_views.demote_organiser_to_member,
          name='demote_organiser_to_member'),
     path('club_profile/<int:c_pk>/members/<int:u_pk>/kick', club_views.kick_user_from_club, name='kick_user_from_club'),
     path('club_profile/<int:c_pk>/members/<int:u_pk>/transfer', club_views.transfer_ownership,
          name='transfer_ownership'),
     path('club_profile/<int:c_pk>/edit/', club_views.ClubUpdateView.as_view(), name='edit_club'),
     path('club_profile/<int:club_id>/meetings/<int:meeting_id>/edit', meeting_views.MeetingUpdateView.as_view(),
          name='edit_meeting'),
     path('favourites/', book_views.Favourites.as_view(), name='favourites'),
     path('book_profile/<int:book_id>/favourite', book_views.make_favourite_book_profile,
          name="make_favourite_book_profile"),
     path('book_profile/<int:book_id>/unfavourite', book_views.unfavourite_book_profile,
          name="unfavourite_book_profile"),
     ...
     path('user_profile/<int:user_id>/unfollow/', user_views.unfollow_from_user_profile,
          name='unfollow_from_user_profile'),
     path('club_profile/<int:club_id>/new_post/', post_views.NewPostView.as_view(), name='new_post'),
     path('user_profile/<int:user_id>/create_chat/', messaging_views.createChatFromProfile,
          name='create_chat_from_profile'),
     ...
     path('club_profile/<int:club_id>/meetings/<int:meeting_id>/delete', meeting_views.remove_from_meeting_list,
          name='delete_meeting'),
     path('user_posts/', user_post_views.UserPostsView.as_view(), name='user_posts'),
     path('club_posts/', post_views.ClubPostsView.as_view(), name='club_posts'),
]
