...
urlpatterns = [
    ...
    path('user_profile/user_feed/', user_feed_views.UserFeedView.as_view(), name='user_feed'),
    path('user_profile/user_new_post/', post_views.NewPostView.as_view(), name='user_new_post'),
    ]
