...
urlpatterns = [
    ...
    path('user_profile/<int:user_id>/follow_toggle/', user_views.follow_from_user_profile , name = 'follow_from_user_profile'),
    path('users/follow_toggle/<int:user_id>/', user_views.follow_from_user_list , name = 'follow_from_user_list'),
