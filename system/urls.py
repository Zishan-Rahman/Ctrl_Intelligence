...
urlpatterns = [
    ...
    path('add_to_reading_list_list/<int:book_id>/', book_views.add_to_reading_list_book_list, name='add_to_reading_list_book_list'),
    path('remove_from_reading_list_list/<int:book_id>/', book_views.remove_from_reading_list_book_list, name='remove_from_reading_list_book_list'),
    path('add_to_reading_list_profile/<int:book_id>/', book_views.add_to_reading_list_book_profile, name='add_to_reading_list_book_profile'),
    path('remove_from_reading_list_profile/<int:book_id>/', book_views.remove_from_reading_list_book_profile, name='remove_from_reading_list_book_profile'),
