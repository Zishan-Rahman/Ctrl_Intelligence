...
urlpatterns = [
    ...
    path('user/', account_views.UsersListView.as_view() , name = 'user_list'),
    path('club/', club_views.ClubsListView.as_view() , name = 'club_list'),
    path('book/', book_views.BooksListView.as_view() , name = 'book_list'),
