...
urlpatterns = [
    ...
    #path('books_read/<int:user_id>/', book_views.books_read, name='books_read'),
    path('add_to_current_reads/<int:book_id>/', book_views.add_to_current_reads, name='add_to_current_reads'),
    path('remove_from_current_reads/<int:book_id>/', book_views.remove_from_current_reads, name='remove_from_current_reads'),
    #path('add_to_books_read/<int:book_id>/', book_views.add_to_books_read, name='add_to_books_read'),
